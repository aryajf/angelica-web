                    ...
                    return (
                        ...
                        >
                            <div
                                ...
                                aria-hidden
                            />
                            <div className="relative h-full rounded-3xl bg-white/95 p-6 shadow-soft ring-1 ring-gold-100/70 backdrop-blur transition-shadow duration-500 group-hover:shadow-cute">
